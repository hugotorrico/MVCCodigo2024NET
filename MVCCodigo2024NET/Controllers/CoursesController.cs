...
namespace MVCCodigo2024NET.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public IActionResult Index1(string searchTerm)
        {
            var products = _context.Courses.AsQueryable();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CourseID,Name,Description,Credit")] Course course)
        {
